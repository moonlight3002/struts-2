            ...
            <div class="row d-flex justify-content-center">
                <div class="col-12">
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="Success-text col-12"><h5>Link is expired. we've send a new verification link to you email</h5></div>
                        <a class="col-12 redirectlink" href="http://localhost:8080/ID0420FF19OWidya/home/login">Go to Login</a>
                    </div>
