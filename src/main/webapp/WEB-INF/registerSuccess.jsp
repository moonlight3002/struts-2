            ...
            <div class="row d-flex justify-content-center">
                <div class="col-12">
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="Success-text col-12"><h5>We had sent verification link to your email address. Please click the link for verification.</h5></div>
                        <a class="col-12 redirectlink" href="http://localhost:8080/ID0420FF19OWidya/home/login">Back to Login</a>
                    </div>
